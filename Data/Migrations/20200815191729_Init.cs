        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HolidayDate = table.Column<string>(type: "nvarchar(100)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Team = table.Column<string>(type: "nvarchar(250)", nullable: false),
                    Position = table.Column<string>(type: "nvarchar(250)", nullable: false),
                    DateOfJoin = table.Column<string>(type: "nvarchar(250)", nullable: false),
                    ...
                    Gender = table.Column<string>(type: "nvarchar(11)", nullable: false),
                    PassportNo = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    ExPassportDate = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    ...
                    EmploymentOfSpouse = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    CountChildrens = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankAddress = table.Column<string>(type: "nvarchar(100)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BankInfo_Profiles_ProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Relationship = table.Column<string>(type: "nvarchar(500)", nullable: false),
